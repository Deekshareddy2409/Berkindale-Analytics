      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={6}>
          <Paper>
            ...
            <MultiLineChart data={multiLineData.slice(0, 4)} title="Performance Trajectory By Algo" />
          </Paper>
        </Grid>
        <Grid item xs={12} md={6}>
          <Paper>
            
            <MultiLineChart data={multiLineData.slice(4)} title="Adverse Selection By Algo" />
          </Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          <Paper>
           
            <Bar data={data} title="IS Cost By Algo" />
          </Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          <Paper>
            
            <Bar data={data} title="VWAP Cost By Algo" />
          </Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          <Paper>
           
            <Bar data={data} title="Commision By Algo" />
          </Paper>
        </Grid>
      </Grid>
    </Box>
