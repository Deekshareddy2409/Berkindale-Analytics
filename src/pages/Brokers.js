    ...
    <Box>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <MultiLineChart data={multiLineData.slice(0, 4)} title="Adverse Selection By Broker" />
          </Paper>
        </Grid>
        <Grid item xs={12} md={6}>
          <Paper>
            
          <Bar data={data} title="Spread Cross By Broker" />
          </Paper>
        </Grid>
        <Grid item xs={12} md={6}>
          <Paper>
            
          <Donut data={exampleData} title="Value Traded By Broker" />
          </Paper>
        </Grid>
      </Grid>
    </Box>
